        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 pb-16">
            ...
            <div>
                ...
                <ul class="space-y-4">
                    ...
                    <li><a href="#" class="text-sm text-gray-600 hover:text-secondary transition-colors">Kebijakan Privasi</a></li>
                    <li><a href="#" class="text-sm text-gray-600 hover:text-secondary transition-colors">Syarat & Ketentuan</a></li>
                </ul>
            </div>

            <!-- Contact -->
            <div>
                <h4 class="text-gray-900 font-bold text-sm mb-6 uppercase tracking-wider">Dukungan</h4>
                <ul class="space-y-4">
