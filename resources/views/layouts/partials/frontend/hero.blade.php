        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div class="space-y-6">
                ...
                <div class="flex flex-wrap gap-4">
                    <a href="{{ route('products.index') }}" class="btn-secondary bg-white text-primary hover:bg-gray-100 px-8 py-3 rounded-lg font-semibold transition flex items-center gap-2">
                        <!-- Shopping Bag Icon -->
                    ...
                    <a href="{{ route('customer.custom-order.create') }}" class="btn-outline border-2 border-white text-white hover:bg-white hover:text-primary px-8 py-3 rounded-lg font-semibold transition flex items-center gap-2">
                        <!-- Paint Brush Icon -->
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
