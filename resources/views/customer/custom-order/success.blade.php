...
@section('title', 'Custom Order Berhasil - ' . config('app.name'))
        ...
        <div class="max-w-2xl mx-auto">
            <div class="bg-white rounded-xl shadow-sm p-8 text-center">
                ...
                <h1 class="text-3xl font-display font-bold text-gray-800 mb-2 flex items-center justify-center gap-2">
                    ...
                    Custom Order Berhasil!
                </h1>
                <p class="text-gray-500 mb-6">Custom order Anda telah berhasil dibuat. Tim kami akan segera mereview dan menghubungi Anda.</p>
                ...
                <div class="bg-gray-50 rounded-lg p-6 text-left mb-6">
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <p class="font-semibold text-yellow-600">Menunggu Review</p>
                        </div>
                        <div>
                            <p class="text-sm text-gray-500">Ukuran</p>
                            <p class="font-semibold text-gray-800">{{ $customOrder->size->name }}</p>
                        </div>
                        <div>
                            <p class="text-sm text-gray-500">Jumlah</p>
                            <p class="font-semibold text-gray-800">{{ $customOrder->quantity }}</p>
                        </div>
                        <div class="col-span-2">
                            <p class="text-sm text-gray-500">Deskripsi Custom</p>
                            <p class="font-semibold text-gray-800 text-sm">{{ Str::limit($customOrder->custom_description, 100) }}</p>
                        </div>
                    </div>
                </div>
