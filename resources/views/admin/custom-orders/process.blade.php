...
@section('title', 'Proses Custom Order - Admin Panel')
@section('page_title', 'Proses Custom Order')
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <select name="status" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary transition" required>
                            <option value="pending" {{ $customOrder->status === 'pending' ? 'selected' : '' }}>Menunggu</option>
                            <option value="review" {{ $customOrder->status === 'review' ? 'selected' : '' }}>Review</option>
                            <option value="design" {{ $customOrder->status === 'design' ? 'selected' : '' }}>Desain</option>
                            <option value="production" {{ $customOrder->status === 'production' ? 'selected' : '' }}>Produksi</option>
                            <option value="shipped" {{ $customOrder->status === 'shipped' ? 'selected' : '' }}>Dikirim</option>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Harga Quote</label>
                        <input type="number" name="price_quote" 
                               ...
                               placeholder="Masukkan harga quote" min="0">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="date" name="estimated_completion_date" 
                               value="{{ $customOrder->estimated_completion_date ? $customOrder->estimated_completion_date->format('Y-m-d') : '' }}"
                               class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary transition">
                    </div>
