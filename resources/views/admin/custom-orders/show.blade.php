...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    ...
    <div class="lg:col-span-2 space-y-6">
        <div class="bg-white rounded-xl shadow-sm p-6">
            <h3 class="font-semibold text-gray-800 mb-4">📋 Informasi Custom Order</h3>
        ...
        <!-- Custom Description -->
        <div class="bg-white rounded-xl shadow-sm p-6">
            <h3 class="font-semibold text-gray-800 mb-4">🎨 Deskripsi Custom</h3>
        ...
        <div class="bg-white rounded-xl shadow-sm p-6">
            ...
            <p class="text-gray-700 mt-1">📞 {{ $customOrder->phone }}</p>
    ...
    <div class="space-y-6">
        ...
        <!-- Back -->
        <a href="{{ route('admin.custom-orders.index') }}" class="block text-center btn-secondary py-3 rounded-lg">
            ← Kembali ke Daftar
        </a>
    </div>
</div>
