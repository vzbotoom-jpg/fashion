    ...
    <div class="container-custom">
        ...
        <div class="max-w-5xl mx-auto space-y-24">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
                <div class="bg-gray-50/50 p-12 rounded-3xl border border-gray-100">
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div class="bg-white p-10 rounded-2xl text-center border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-300">
                        <div class="w-20 h-20 bg-gray-50 text-primary rounded-2xl flex items-center justify-center mx-auto mb-8">
